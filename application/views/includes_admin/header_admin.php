                  ...
                  <img src="<?php echo base_url() ?>assets/images/logo/logosetrumheader.png" >
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <ul class="nav navbar-nav navbar-right margin-top">
                            ...
                            <li>
                                <a href="#" class="text-white"><i class="glyphicon glyphicon-user inverse"> </i><?php echo $this->session->userdata('username'); ?></a>
                            </li>
                ...
                <!-- left content -->
                    <div class="col-md-3 mr-top-50 ">
                        <div class="list-group br-shadow">
                            ...
                            <a href="<?php echo base_url(); ?>admin/ctrl_admin/data_user" class="list-group-item">Data User<i class="glyphicon glyphicon-chevron-right pull-right"></i></a>
                            <a href="<?php echo base_url(); ?>admin/ctrl_admin/data_produk" class="list-group-item">Data Item<i class="glyphicon glyphicon-chevron-right pull-right"></i></a>
                            <a href="<?php echo base_url(); ?>admin/ctrl_admin/tambah_produk" class="list-group-item">Upload Produk<i class="glyphicon glyphicon-chevron-right pull-right"></i></a>
                            <a href="<?php echo base_url(); ?>admin/ctrl_admin_produk/produkStatus" class="list-group-item">Status Produk<i class="glyphicon glyphicon-chevron-right pull-right"></i></a>
